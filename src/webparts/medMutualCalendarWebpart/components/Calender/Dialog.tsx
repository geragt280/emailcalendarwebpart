...
const Dialog : React.FunctionComponent<DialogProps> = ({hideModal, selectedItem}) => {
    ...
    <div>
        ...
        <div className={styles.body}>
            <div style={{ display: 'flex', position: 'relative', flexDirection: 'column' }}>
                ...
                <div style={{ width: 60, height: 40, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}><Icon iconName='EventInfo' style={{ fontSize: 25, color: colorCodes['Blue'] }} /></div>
                ...
                <div style={{ width: 450, height: 40, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                <div style={{ width: 60, height: 40, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}><Icon iconName='Clock' style={{ fontSize: 20, color: colorCodes['Default'] }} /></div>
                ...
                <div style={{ width: 450, height: 40, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                <div style={{ width: 60, height: 40, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}><Icon iconName='KnowledgeArticle' style={{ fontSize: 20, color: colorCodes['Default'] }} /></div>
