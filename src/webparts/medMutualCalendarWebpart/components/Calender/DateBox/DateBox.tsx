...
export const DateBox = (props: IDateBoxProps) => {
  ...
  const backgroundColor: string = themeVariant && themeVariant;
  ...
  const borderColor: string = themeVariant && backgroundColor != themeVariant ? themeVariant : "[theme:neutralLight, default: #eaeaea]";
